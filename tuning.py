...
for index, m in enumerate(data):
    ...
    fig.savefig(os.path.join(PLOTS_DIR,'OrientationTuning/AvgRsp-%c.png'% name),
                bbox_inches='tight')
    plt.close()
    ...
    fig.savefig(os.path.join(PLOTS_DIR,
                             'OrientationTuning/Selectivity-%c.png' % name),
                bbox_inches='tight')
    plt.close()
    ...
    for i in range(m.N):
        ...
        fig.savefig(os.path.join(PLOTS_DIR,
                                 'OrientationTuning/TuningCurves-%c/OT-%c_%d.png'
                                 % (name, name, i)),
                    bbox_inches='tight')
        plt.close()
        ...
        fig.savefig(os.path.join(PLOTS_DIR,
                                 'OrientationTuning/CirVecs-%c/Vecs-%c_%d.png'
                                 % (name,name,i)),
                    bbox_inches='tight')
        plt.close()
